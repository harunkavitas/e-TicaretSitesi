...
namespace Hunter.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class CartController : Controller
    {
        ...
        private Payment PaymentProcess(ShoppingCartVM model)
        {
            ...
            options.ApiKey = "sandbox-hENgp0BYkOVCAa3GMQmje2MBclCWODVW";
            options.SecretKey = "sandbox-dtUwst5mzmA5YBRudtY7r1ZWZaAKQwY4";
